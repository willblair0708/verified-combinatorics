"""General rung q (Erdos #617): (6,5,5,5,5) shape, all internal configs.
Originally rung 62 (Erdos #617): (6,5,5,5,5) shape, all internal configs.
...
def fivepart_dists(k):
    ...
    if k == 2:
        return [
            [(P1[0],P1[1]),(P1[2],P1[3])],            # matching in one part
            [(P1[0],P1[1]),(P1[1],P1[2])],            # path in one part
            [(P1[0],P1[1]),(P2[0],P2[1])],            # 1 in each of two parts
        ]
    P3 = PARTS[3]
    if k == 3:
        return [
            [(P1[0],P1[1]),(P1[1],P1[2]),(P1[2],P1[3])],   # P4 in one part
            [(P1[0],P1[1]),(P1[1],P1[2]),(P1[0],P1[2])],   # triangle in one part
            [(P1[0],P1[1]),(P1[0],P1[2]),(P1[0],P1[3])],   # star K1,3 in one part
            [(P1[0],P1[1]),(P1[1],P1[2]),(P1[3],P1[4])],   # path+edge in one part
            [(P1[0],P1[1]),(P1[2],P1[3]),(P2[0],P2[1])],   # matching(2) + 1 in 2nd part
            [(P1[0],P1[1]),(P1[1],P1[2]),(P2[0],P2[1])],   # path(2) + 1 in 2nd part
            [(P1[0],P1[1]),(P2[0],P2[1]),(P3[0],P3[1])],   # 1 in each of three parts
        ]
    raise ValueError(k)
...
def main():
    ...
    print(f"\n{ncfg} configs tested. VERDICT:",
          f"(6,5,5,5,5) dead at e(H)={270-q} => m* >= {56+q}" if allinf
